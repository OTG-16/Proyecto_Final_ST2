...
def getTipe(Var,ambito):
    ...
    while (i<len(VarsCode)):
        print("Value: "+VarsCode[i][0]+" Ambito: "+VarsCode[i][2])
        if (ambito == VarsCode[i][2] or VarsCode[i][2] == "#"):
            print(Var.lstrip()+"=="+VarsCode[i][0].lstrip())
            if (Var.lstrip() == VarsCode[i][0].lstrip()):
                print(Var+" -- "+ VarsCode[i][0])
...
class R8():
    ...
    def getInfo(self,ambito,tipo):
        ...
        if (len(comp) > 0):
            QMessageBox.information(self,'Mensaje',comp)
            sys.exit(1)
...
class R9():
    ...
    def getInfo(self,o1=0,o2=0):
        ...
        if (len(Exist)>0):
            QMessageBox.information(self,'Mensaje',Exist)
            sys.exit(1)
...
class R11():
    ...
    def getInfo(self,ambito,o2=0):
        ...
        if (len(axist) > 0):
            QMessageBox.information(self,'Mensaje',axist)
            sys.exit(1)
...
class R36():
    ...
    def getInfo(self,ambito,tipo):
        ...
        if (tipe != tipo  and tipo!="all"):
            QMessageBox.information(self,'Mensaje',"Error de asiognacion o retorno de variable "+tipo +" con "+tipe)
            sys.exit(1)
...
class R37():
    ...
    def getInfo(self,ambito,tipo):
        ...
        if (tipo != "int"  and tipo!="all"):
            QMessageBox.information(self,'Mensaje',"Error de asiognacion o retorno de variable "+tipo+" con int")
            sys.exit(1)
        return "int"
...
class R39():
    ...
    def getInfo(self,ambito,tipo):
        ...
        if (tipo != "string"  and tipo!="all"):
            QMessageBox.information(self,'Mensaje',"Error de asiognacion de variable")
            sys.exit(1)
...
class R40():
    ...
    def getInfo(self,ambito,tipo):
        ...
        if (tipe!=tipo and tipo!="all"):
            QMessageBox.information(self,'Mensaje',"La funcion "+self.identificador + " no es de tipo " + tipo)
            sys.exit(1)
